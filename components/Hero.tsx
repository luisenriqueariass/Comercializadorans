      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center pt-24 pb-16">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-500 text-white font-bold px-7 py-3.5 rounded-lg text-base transition-colors shadow-lg shadow-green-600/20"
          >
