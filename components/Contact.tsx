        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              className="group flex items-center gap-4 bg-charcoal-800 border border-charcoal-700 hover:border-brand-600/50 rounded-xl p-5 transition-all"
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-brand-600/10 border border-brand-600/30 flex items-center justify-center text-brand-400">
              ...
              <span className="text-brand-500 text-sm font-semibold group-hover:underline">{t('ctaWhatsapp')} →</span>
            </a>
            ...
            >
              ...
              <span className="text-brand-500 text-sm font-semibold group-hover:underline">{t('ctaEmail')} →</span>
            </a>
            ...
            >
              ...
              <span className="text-brand-500 text-sm font-semibold group-hover:underline">{t('ctaInstagram')} →</span>
            </a>
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-charcoal-600 border border-charcoal-500 flex items-center justify-center text-gray-400 group-hover:text-brand-400 transition-colors">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-brand-500 text-sm font-semibold group-hover:underline whitespace-nowrap">{t('ctaMap')} →</span>
            </a>
          </div>
