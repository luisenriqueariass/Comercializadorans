        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              className="group flex items-center gap-4 bg-charcoal-800 border border-charcoal-700 hover:border-amber-500/50 rounded-xl p-5 transition-all"
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-green-500/10 border border-green-500/30 flex items-center justify-center text-green-400">
              ...
              <span className="text-amber-500 text-sm font-semibold group-hover:underline">{t('ctaWhatsapp')} →</span>
            </a>
            ...
            <a
              ...
              className="group flex items-center gap-4 bg-charcoal-800 border border-charcoal-700 hover:border-amber-500/50 rounded-xl p-5 transition-all"
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400">
              ...
              <span className="text-amber-500 text-sm font-semibold group-hover:underline">{t('ctaEmail')} →</span>
            </a>
